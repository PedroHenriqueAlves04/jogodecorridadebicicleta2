...
//definir collider para o ciclista
  ciclistaPrincipal.setCollider("rectangle",0,0,40,ciclistaPrincipal.width,ciclistaPrincipal.height);
  ciclistaPrincipal.debug = false;
  
fimdeJogo = createSprite(400,150);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    //Adicione o código para mostrar instruções de reinicialização do jogo em texto aqui
     textSize(20);
  text("“Aperte a tecla direcional para cima para reiniciar o   jogo!",150,250)
